...
export default function Overview() {
  const { selectedMerchant, merchantDisputes, dataAsOf } = useData()
  ...
  return (
    <div className="flex flex-col">
      <div className="mb-5">
        <h1 className="text-[22px] font-semibold text-ink">Dispute overview</h1>
        <p className="mt-1 text-sm text-slate">
          {m.name} · {m.n_disputes} open disputes · Data as of {dataAsOf}
        </p>
      </div>
